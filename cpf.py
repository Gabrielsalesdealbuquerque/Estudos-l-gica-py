...
while i != 0:
    ...
    num10 = primeiro_digito_verificador

    if primeiro_digito_verificador == len(cpf):
    ...
    num11 = segundo_digito_verificador

    if segundo_digito_verificador == len(cpf):
    ...
    if (primeiro_digito_verificador == num10 and segundo_digito_verificador == num11):
        print('CPF é válido.')
        print('Os dois ultimos Dígitos na ordem correta:',num10,num11)
        print(" ")
print('obrigado')
